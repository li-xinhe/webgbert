...
const translations = {
  en: {
    ...
    footer_meta: "Thanks for Manifesto project. Version: 2025-1. Berlin: WZB Berlin Social Science Center/Göttingen: Institute for Democracy Research (IfDem).This website is for academic and educational use only. ",
