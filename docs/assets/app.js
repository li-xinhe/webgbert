...
const translations = {
  ...
  ja: {
    ...
    footer_meta: "<p>本ウェブサイトの作成者は、Manifestoプロジェクト（Version 2025-1, Berlin: WZB Berlin Social Science Center / Göttingen: Institute for Democracy Research (IfDem)）に謝意を表します。</p><p>本ウェブサイトは、研究および教育目的のみに使用されています。</p>",
